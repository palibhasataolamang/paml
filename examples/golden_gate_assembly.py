...
dna_sources = protocol.input_value(
    "source_samples", "http://bioprotocols.org/paml#SampleCollection"
)
# TODO: add_input should be returning a usable ActivityNode!
dna_build_layout = protocol.input_value(
    "build_layout", "http://bioprotocols.org/paml#SampleData"
)
...
output = protocol.designate_output(
    "constructs",
    "http://bioprotocols.org/paml#SampleCollection",
