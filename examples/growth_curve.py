...
split_and_measure = paml.Protocol(
...
overnight_od_measure = paml.Protocol(
...
overnight_plate = paml.Container(
    name="Overnight Growth Plate", type=tyto.NCIT.Microplate, max_coordinate="H12"
)
overnight_od_plate = paml.Container(
    name="Overnight Growth Plate", type=tyto.NCIT.Microplate, max_coordinate="H12"
)
growth_plate = paml.Container(
